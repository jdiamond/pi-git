...
export function register(pi: {
	...
	pi.registerTool({
		...
		label: "Git Amend",
		description:
			"Amend the most recent commit. Optionally provide a new message and/or files to stage. Shows a review prompt where the user can accept, edit, or cancel before the amend executes.",
