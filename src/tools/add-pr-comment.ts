...
export function register(pi: {
	...
	pi.registerTool({
		...
		description:
			"Add a top-level conversation comment on a GitHub pull request. Shows a review overlay where the user can approve, edit, or cancel before the comment is posted.",
